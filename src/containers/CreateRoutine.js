...
import { faPlus, faTimes, faClock, faRunning, faRedo } from "@fortawesome/free-solid-svg-icons";
import { library } from "@fortawesome/fontawesome-svg-core";
library.add(faPlus, faTimes, faClock, faRunning, faRedo);
...
export default function CreateRoutine(props) {
    ...
    return (
        <div className="overflow-hidden overflow-y-auto pb-10" style={{ height: "78vh" }} >
            <div className="h-2/3">
                ...
                <div className="lg:flex">
                    <div className="lg:w-1/2 md:w-2/3 w-full md:mx-auto md:mt-3">
                        <form className="bg-gray-800 text-white p-4 rounded mx-auto" style={{ maxWidth: "400px" }}>
                            <div>
                    ...
                    <div className="lg:w-1/2 md:w-2/3 w-full md:mx-auto md:mt-3 mt-2">
                        {state.collectionWorkout && state.collectionWorkout.map((element, idx) => {
                            return (
                                <div key={idx} className="flex p-3 rounded bg-gray-200 mb-4 mx-auto" style={{ maxWidth: "400px" }}>
                                    <div className="w-11/12 py-2 flex">
                                        <div className="w-2/3">
                                            <p className="mr-2">{element.name}</p>
                                        </div>
                                        <FontAwesomeIcon icon={faClock} className="mr-1 my-auto"></FontAwesomeIcon>
                                        <span className="mr-4 my-auto">{element.time}</span>
                                        <FontAwesomeIcon icon={faRedo} className="mr-1 my-auto"></FontAwesomeIcon>
                                        <span className="my-auto"> {element.reps}</span>
